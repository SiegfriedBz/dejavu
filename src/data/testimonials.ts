    ...
    items: [
      {
        ...
        variants: [
          ...
          { id: 3, duration: "1h", price: "180K", outCall: true },
          { id: 4, duration: "1.5h", price: "270K", outCall: true },
        ],
      },
      {
        id: 2,
...
export const TESTIMONIALS_QUOTES = [
  {
    id: 1,
    message: "The best massage my boyfriend and I ever had! 1000/10 🙏",
    author: "Yana S.",
  },
  {
    id: 8,
  ...
  },
  {
    id: 7,
    message:
      "Really lovely staff, always friendly. Definitely the best place to get an amazing massage in Canggu!",
    author: "Jennie W.",
  },
  {
    id: 2,
    message:
      "I had such amazing massages in this spa. Definitely my favorite place in Canggu. I recommend Deja Vu 100% I go quite often. The therapists and the owner, Delillah, are really pro and kind. .",
    author: "Eric M.",
  },
  {
    id: 3,
    message:
      "The best massage in Bali. After flight is exactly the way to start a holiday.",
    author: "Alex R.",
  },
  {
    id: 4,
    message:
      "Excellent massage. I've tried many in Canggu and this place is definitely the best. The therapists are really skilled and nice. And the light background music very relaxing. Definitely recommend.",
    author: "Marcello A.",
  },
  {
    id: 5,
    message:
      "Had an amazing foot massage at this place, we had a lovely experience and we were welcomed with big smiles, the best and cheapest option around town would definitely recommend this place!",
    author: "Amanda D.",
  },
  {
    id: 6,
    message:
      "Had the best massage of my life here and definitely the best place to get an amazing massage in Canggu! Really lovely staff always friendly.",
    author: "Ed W.",
  },
];
